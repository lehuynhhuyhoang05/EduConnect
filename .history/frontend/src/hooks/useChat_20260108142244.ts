...
export const chatKeys = {
  ...
  classMessages: (classId: string) => [...chatKeys.all, 'classMessages', classId] as const,
};
...
export function useClassMessages(classId: string, params?: { page?: number; limit?: number }) {
  return useQuery({
