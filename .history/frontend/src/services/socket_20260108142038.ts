...
export const sendWebRTCOffer = (sessionId: number, targetUserId: number, offer: RTCSessionDescriptionInit): void => {
  sendWebRTCSignal(targetUserId, 'offer', offer);
};

export const sendWebRTCAnswer = (sessionId: number, targetUserId: number, answer: RTCSessionDescriptionInit): void => {
