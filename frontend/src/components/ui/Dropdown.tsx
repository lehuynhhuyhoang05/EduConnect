...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      'rounded-xl p-1.5',
      'shadow-lg dark:shadow-dark-soft',
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive
        ? 'text-error-600 dark:text-error-400 focus:bg-error-50 dark:focus:bg-error-900/20'
        : 'text-neutral-700 dark:text-neutral-300 focus:bg-neutral-100 dark:focus:bg-neutral-800',
