  ...
  <div>
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="mt-2 space-y-1">
            ...
            >
              <span class="font-mono bg-muted px-1.5 py-0.5 rounded">{{ account.email }}</span>
    ...
    <form class="space-y-5" @submit.prevent="handleSubmit">
        ...
        <div class="relative">
          ...
          >
            ...
            <svg v-else class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <path d="M7.5 7.5a10.94 10.94 0 0 1 4.5-1c5.93 0 8.93 4.03 9.938 5.652a1 1 0 0 1 0 1.096 14.62 14.62 0 0 1-1.3 1.857"/>
            </svg>
          </button>
        </div>
      ...
      >
        <span v-if="!isLoading" class="flex items-center justify-center gap-2">
          Đăng nhập
          <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M5 12h14"/>
    ...
    <div class="relative my-8">
      ...
      <div class="relative flex justify-center text-xs uppercase">
        <span class="bg-background px-4 text-muted-foreground">Hoặc tiếp tục với</span>
      </div>
    </div>
